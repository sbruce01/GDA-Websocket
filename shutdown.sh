...
ps aux | grep ' feedhandler_gda.q' | grep '5111'| grep -v grep | awk '{print $2}' | xargs -I {} kill -9 {}
...
ps aux | grep ' eod_write.q' | grep '5555'| grep -v grep | awk '{print $2}' | xargs -I {} kill -9 {}